...
function Home() {
  ...
  // 🛍️ Function to navigate to products page
  const goToProducts = () => {
    navigate("/products");
  };

  // 🛍️ Function to navigate to specific product detail page (if needed)
    ...
    <div className="w-full bg-black min-h-screen pb-20 text-white font-sans selection:bg-[#00e676] selection:text-black">
      ...
      <div className="relative w-full h-[400px] md:h-[550px] overflow-hidden group flex justify-center pt-5">
        <div className="w-[95%] md:w-[94%] h-full relative overflow-hidden rounded-[2rem] shadow-2xl border border-white/5">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/40 to-transparent flex flex-col justify-center px-8 md:px-20">
            ...
            {/* 🛍️ Shop Now Button - Navigates to Products Page */}
            <button 
              onClick={goToProducts} 
              className="w-fit bg-[#00e676] hover:bg-white text-black font-black py-4 px-14 rounded-full transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(0,230,118,0.4)]"
            >
              SHOP NOW
            </button>
          </div>
      ...
      <div className="w-full px-6 md:px-14 mb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {hotDeals.map((item) => (
            <div 
              key={item.id} 
              className="group relative bg-[#0a0a0a] rounded-[2.5rem] p-8 flex flex-col items-center border border-white/5 hover:border-[#00e676]/30 transition-all duration-500 cursor-pointer overflow-hidden"
              onClick={goToProducts}
            >
      ...
      <div className="w-full px-6 md:px-14">
        <div className="flex items-center justify-between mb-10">
          ...
          <button 
            onClick={goToProducts} 
            className="text-[#00e676] font-bold border-b-2 border-[#00e676]/30 hover:border-[#00e676] transition-all"
          >
            VIEW ALL
          </button>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {techzoneExclusives.map((prod) => (
            <div 
              key={prod.id} 
              className="group bg-[#111] rounded-[2rem] overflow-hidden border border-white/5 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)] transition-all flex flex-col cursor-pointer"
              onClick={goToProducts}
            >
                ...
                <div className="mt-auto">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    ...
                    <button 
                      ...
                      className="bg-white/10 hover:bg-[#00e676] p-3 rounded-xl transition-all group/btn"
                    >
      ...
      <div className="w-full px-6 md:px-14 py-20 bg-black">
        ...
        <div className="space-y-24">
          {TheLatest.map((item, index) => (
            <div 
              key={item.id} 
              className={`flex flex-col ${index % 2 !== 0 ? 'md:flex-row-reverse' : 'md:flex-row'} items-center gap-12 md:gap-20 cursor-pointer`}
              onClick={goToProducts}
            >
              <div className="flex-1 space-y-6">
                ...
                <button 
                  ...
                  className="border-b-2 border-[#00e676] text-[#00e676] pb-1 font-bold hover:text-white hover:border-white transition-all"
                >
                  LEARN MORE
                </button>
              </div>
        ...
        <div className="relative w-full h-[500px] md:h-[700px] overflow-hidden group">
          ...
          <div className="absolute inset-0 bg-black/40 flex flex-col justify-center px-8 md:px-24">
            <div className="max-w-4xl text-left">
              ...
              <button 
                onClick={goToProducts} 
                className="bg-[#00e676] text-black font-black py-4 px-12 rounded-full hover:bg-white transition-all transform hover:scale-105 active:scale-95 shadow-2xl"
              >
                DISCOVER MORE
              </button>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 h-auto md:h-64 text-white">
        <div className="bg-[#e03e3e] flex items-center justify-around p-8 cursor-pointer group" onClick={goToProducts}>
        ...
        <div className="bg-[#1f9e54] flex items-center justify-around p-8 border-l border-white/10 cursor-pointer group" onClick={goToProducts}>
        ...
        <div className="bg-[#2e8b91] flex items-center justify-around p-8 border-l border-white/10 cursor-pointer group" onClick={goToProducts}>
      ...
      <div className="max-w-7xl mx-auto py-20 px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { img: "https://media-ik.croma.com/prod/https://media.tatacroma.com/Croma%20Assets/Computers%20Peripherals/Laptop/Images/315367_0_L8SqpdqXa.png?updatedAt=1758638361381?tr=w-640", tag: "High Performance", title: "Gaming" },
            { img: "https://media-ik.croma.com/prod/https://media.tatacroma.com/Croma%20Assets/Computers%20Peripherals/Laptop/Images/314123_0_xa42dw.png?tr=w-400", tag: "New Gen", title: "AI & Tech" },
            { img: "https://media-ik.croma.com/prod/https://media.tatacroma.com/Croma%20Assets/Computers%20Peripherals/Laptop/Images/320129_1_0tarw43YAd.png?updatedAt=1766587608663?tr=w-400", tag: "Movies & Chill", title: "Entertainment" },
            { img: "https://media-ik.croma.com/prod/https://media.tatacroma.com/Croma%20Assets/Computers%20Peripherals/Laptop/Images/315874_0_vyYytdChQ.png?updatedAt=1770706496631?tr=w-400", tag: "Home & Office", title: "Everyday Use" }
          ].map((item, index) => (
            <div key={index} className="rounded-[2rem] overflow-hidden shadow-2xl group cursor-pointer relative h-72 border border-white/5" onClick={goToProducts}>
              <img src={item.img} className="object-cover w-full h-full group-hover:scale-110 transition duration-700 opacity-80 group-hover:opacity-100" />
              <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent"></div>
              <div className="absolute bottom-6 left-6">
                <div className="text-[#00e676] text-xs font-black uppercase tracking-widest mb-1">{item.tag}</div>
                <div className="text-white text-2xl font-black uppercase">{item.title}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="w-full bg-[#111] mt-20">
        <div className="flex flex-col md:flex-row min-h-[500px]">
          <div className="flex-1 bg-black flex flex-col justify-center p-10 md:p-20">
            ...
            <button onClick={goToProducts} className="text-white border-b border-white w-fit pb-1 text-sm hover:text-[#00e676] hover:border-[#00e676] transition-all">
              Learn More
            </button>
          </div>
      ...
      <section className="w-full bg-black">
        <div className="flex justify-between items-center px-6 md:px-14 py-6">
          ...
          <button onClick={goToProducts} className="text-gray-400 hover:text-[#00e676] text-sm flex items-center gap-1 transition-colors uppercase font-bold tracking-widest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                <li className="hover:text-[#00e676] cursor-pointer transition-colors" onClick={goToProducts}>Laptops & PC</li>
                <li className="hover:text-[#00e676] cursor-pointer transition-colors" onClick={goToProducts}>Smart Watches</li>
                <li className="hover:text-[#00e676] cursor-pointer transition-colors" onClick={goToProducts}>Headphones & Audio</li>
                <li className="hover:text-[#00e676] cursor-pointer transition-colors" onClick={goToProducts}>Smart LED TVs</li>
                <li className="hover:text-[#00e676] cursor-pointer transition-colors" onClick={goToProducts}>Mobile Phones</li>
              </ul>
            </div>
